...
volatile uint32_t *MEDIUM_PALETTE2 = (volatile uint32_t *)(0x500F2400);
...
int main() {
    ...
    MEDIUM_PALETTE2[1] = 0xFFFF00FF; // A R G B
    ...
    while (1) {
        ...
        if(global != last_global){
            if(controller_status){
                ...
                MEDIUM_CONTROL[0] = MediumControl(1, (x_pos & 0x3F)<<3, (x_pos>>6)<<3, 0, 0);
            }
            last_global = global;
        }
    }
